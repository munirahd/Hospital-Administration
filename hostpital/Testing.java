...
/* >>>>> */ try {
   ...
   .. to be fullid form the user */ /* >>>>> */ catch (FileNotFoundException ex) {
            fullAdmins(staff);
        }
...
// now we will read form the user the name of the admin 
        ...
        while (check != 1) {
            ...
            if (choies < 1 || choies > 2) {
                System.out.println(" invaild choies  ");
            }
        }
   ...
   salary Double    */
        if (choies == 1) {
            ...
            if (numberAdmins > 3) {
                System.out.println("the number of admins is invaild "
    ...
    public static void the_main_Selections(ArrayList<Employee> list_of_Employee, ArrayList<Patient> list_of_patient, ArrayList<Services> list_of_Services) {
        ...
        while (Selection != 4 && Selection < 4 && Selection > 0) {
            ...
            if (Selection == 1) {
                staff_selection(list_of_Employee, list_of_patient, list_of_Services);
            }
            if (Selection == 2) {
                patient_selection(list_of_Employee, list_of_patient, list_of_Services);
            }
            if (Selection == 3) {
                service_selection(list_of_Employee, list_of_patient, list_of_Services);
            }
        }
        if (Selection == 4) {
        ...
        if (Selection > 4 || Selection < 0) {
            System.out.println("the Selection you enterd is not found  ");
        }
    }
            ...
            while (check != 1) {
                ...
                for (Services s : list_of_Services) {
                    ...
                    if (s.getDectorHowProvdeServices().getID() == ID) {
                        ...
                        System.out.println("invaild id number please try again  ");
                    }
                }
